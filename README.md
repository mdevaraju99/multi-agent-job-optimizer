...
<div align="center"> ![Status](https://img.shields.io/badge/status-active-success.svg) ![Python](https://img.shields.io/badge/python-3.10+-blue.svg) ![FastAPI](https://img.shields.io/badge/FastAPI-0.110+-green.svg) ![React](https://img.shields.io/badge/React-19.2-blue.svg) ![LangChain](https://img.shields.io/badge/LangChain-Latest-purple.svg) **An AI-powered production scheduling system using multi-agent collaboration to optimize job allocation across manufacturing machines.** </div>
📋 Table of Contents
Overview
Features
Architecture
...
cd backend
python main.py
Backend will be available at: - API: http://localhost:8000 - Docs: http://localhost:8000/docs (Interactive API documentation)

Terminal 2 - Frontend Server
cd frontend
npm run dev
Frontend will be available at: - App: http://localhost:5173

Using the Application
Open the Dashboard: Navigate to http://localhost:5173
Select Mode: Choose between Simplified or Comprehensive agent modes
Input Jobs:
...
Add Downtime: Schedule maintenance windows
Run Optimization: Click "Optimize Schedule"
View Results:
...
Agent explanations
Sample Data
The project includes sample CSV files: - sample_jobs.csv - Example job data - sample_downtime.csv - Example maintenance windows

📚 API Documentation
Interactive API Docs
Once the backend is running, visit: - Swagger UI: http://localhost:8000/docs - ReDoc: http://localhost:8000/redoc
...
Via API, use different endpoints: - /api/optimize/simplified - /api/optimize/comprehensive
...
agents-architecture.md - Detailed agent architecture and rules
backend/AGENTS_README.md - Complete implementation guide
IMPLEMENTATION_SUMMARY.md - Implementation notes
MODE_COMPARISON.md - Comparison of agent modes
🐛 Troubleshooting
Backend won't start
